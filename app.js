...
const APPS_DATA = [
  {
    ...
    actionText: '立即開啟使用',
    shortDesc: '跨裝置 P2P 傳送文字與檔案，免註冊、檔案絕對隱私不經伺服器。',
  ...
  },
  {
    ...
    statusClass: 'status-online',
    actionText: '立即開啟使用',
    shortDesc: 'AI 去除背景、去除浮水印、膚色調和，全本機高隱私離線處理。',
  ...
  },
  {
    ...
    title: '簡易影像處理',
    englishTitle: 'Fast Image Inpaint',
    category: 'ai',
    categoryName: 'AI & 影像',
    badge: '去除浮水印 • 膚色調和',
    iconText: 'CV',
    ...
    statusClass: 'status-online',
    actionText: '立即開啟使用',
    shortDesc: '純前端 OpenCV 演算法修補浮水印與膚色，秒開無等待延遲。',
    longDesc: '基於 OpenCV Telea 影像修補演算法的極速修圖工具。專門針對去除照片角落浮水印、路人瑕疵、日期戳記進行演算法最佳化。無需載入數十 MB 的龐大 AI 模型，在網頁打開瞬間即可在瀏覽器本機完成演算法修復，輕巧、敏捷且可靠。',
